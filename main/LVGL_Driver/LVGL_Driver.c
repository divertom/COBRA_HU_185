...
void LVGL_Init(void)
{
    ...
    disp_drv.drv_update_cb = example_lvgl_port_update_callback;                                         // Function : Rotate display when rotated screen in LVGL. Called when driver parameters are updated. 
